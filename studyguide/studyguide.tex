...
\usepackage[natbib,style=numeric-comp,maxbibnames=99,sorting=none,%
  backend=bibtexu]{biblatex}
...
%  \input{lis-aim.tex}
%  \input{vranalys-aim.tex}
%  \input{passwd-aim.tex}
%  \input{pwdpol-aim.tex}
